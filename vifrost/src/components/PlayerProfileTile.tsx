...
export function PlayerProfileTile({ username }: PlayerProfileTileProps) {
  ...
  return (
    <section className="w-full rounded-2xl border border-[var(--colorBorder)] bg-[var(--colorSurfaceAlt)] p-6 lg:max-w-[390px]">
      <h2 className="text-lg font-semibold tracking-wide text-[var(--colorText)]">
        Player Profile
      </h2>

      <div className="mt-5 flex items-center gap-4">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,var(--colorAccent),var(--colorAccentHover))] text-2xl font-semibold text-[var(--colorSurfaceAlt)]">
          {initial}
        </div>
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            ...
            <span className="rounded-full bg-[color-mix(in_oklab,var(--colorText)_8%,transparent)] px-3 py-1 text-xs font-medium text-[var(--colorTextMuted)]">
              Ranked - 1,482 MMR
            </span>
          </div>
      ...
      <div className="mt-5 rounded-xl border border-[color-mix(in_oklab,var(--colorText)_10%,transparent)] bg-[color-mix(in_oklab,var(--colorSurfaceAlt)_55%,var(--colorMain)_45%)] p-4">
        ...
        <div className="mt-3 h-2 overflow-hidden rounded-full bg-[color-mix(in_oklab,var(--colorText)_10%,transparent)]">
          <div className="h-full w-[68%] bg-[linear-gradient(90deg,var(--colorAccent),var(--colorAccentHover))]" />
        </div>
